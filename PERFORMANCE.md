...
- **Message Digest:**
	...
	| Command | Mean [s] | Min [s] | Max [s] | Relative |
	|:---|---:|---:|---:|---:|
	| `blake2b256` | 0.058 ± 0.004 | 0.054 | 0.073 | 1.41 ± 0.20 |
	| `blake2b512` | 0.058 ± 0.003 | 0.054 | 0.068 | 1.40 ± 0.20 |
	| `blake2s128` | 0.058 ± 0.040 | 0.040 | 0.308 | 1.41 ± 0.99 |
	| `blake2s256` | 0.044 ± 0.004 | 0.039 | 0.059 | 1.08 ± 0.16 |
	| `blake3` | 0.054 ± 0.005 | 0.050 | 0.075 | 1.33 ± 0.20 |
	| `cubehash` | 0.158 ± 0.006 | 0.155 | 0.178 | 3.86 ± 0.51 |
	| `echo224` | 0.166 ± 0.005 | 0.161 | 0.177 | 4.04 ± 0.53 |
	| `echo256` | 0.165 ± 0.004 | 0.161 | 0.175 | 4.02 ± 0.53 |
	| `echo384` | 0.274 ± 0.003 | 0.270 | 0.280 | 6.68 ± 0.86 |
	| `echo512` | 0.275 ± 0.005 | 0.270 | 0.287 | 6.71 ± 0.87 |
	| `gost94` | 0.680 ± 0.006 | 0.672 | 0.693 | 16.60 ± 2.13 |
	| `groestl` | 0.152 ± 0.011 | 0.145 | 0.191 | 3.71 ± 0.55 |
	| `jh` | 0.375 ± 0.003 | 0.372 | 0.381 | 9.16 ± 1.18 |
	| `keccak256` | 0.077 ± 0.004 | 0.073 | 0.088 | 1.89 ± 0.26 |
	| `keccak512` | 0.113 ± 0.004 | 0.109 | 0.123 | 2.76 ± 0.36 |
	| `kupyna256` | 0.907 ± 0.006 | 0.899 | 0.917 | 22.11 ± 2.84 |
	| `kupyna384` | 0.591 ± 0.029 | 0.574 | 0.672 | 14.43 ± 1.98 |
	| `kupyna512` | 0.578 ± 0.007 | 0.571 | 0.589 | 14.11 ± 1.82 |
	| `lsh224` | 0.060 ± 0.004 | 0.056 | 0.074 | 1.46 ± 0.21 |
	| `lsh256` | 0.060 ± 0.004 | 0.055 | 0.069 | 1.47 ± 0.21 |
	| `lsh384` | 0.060 ± 0.005 | 0.055 | 0.081 | 1.47 ± 0.22 |
	| `lsh512` | 0.122 ± 0.006 | 0.117 | 0.140 | 2.98 ± 0.41 |
	| `md4` | 0.044 ± 0.004 | 0.039 | 0.060 | 1.07 ± 0.17 |
	| `md5` | 0.044 ± 0.009 | 0.034 | 0.079 | 1.07 ± 0.27 |
	| `rmd128` | 0.053 ± 0.003 | 0.049 | 0.064 | 1.28 ± 0.18 |
	| `rmd160` | 0.059 ± 0.004 | 0.055 | 0.070 | 1.43 ± 0.21 |
	| `rmd256` | 0.053 ± 0.005 | 0.049 | 0.075 | 1.30 ± 0.20 |
	| `sha1` | 0.041 ± 0.006 | 0.034 | 0.063 | 1.01 ± 0.20 |
	| `sha224` | 0.047 ± 0.004 | 0.042 | 0.060 | 1.14 ± 0.17 |
	| `sha256` | 0.047 ± 0.004 | 0.042 | 0.061 | 1.14 ± 0.17 |
	| `sha3-224` | 0.074 ± 0.003 | 0.071 | 0.084 | 1.81 ± 0.25 |
	| `sha3-256` | 0.077 ± 0.004 | 0.073 | 0.094 | 1.87 ± 0.26 |
	| `sha3-384` | 0.089 ± 0.005 | 0.085 | 0.106 | 2.18 ± 0.30 |
	| `sha3-512` | 0.117 ± 0.006 | 0.110 | 0.133 | 2.85 ± 0.39 |
	| `sha384` | 0.080 ± 0.006 | 0.075 | 0.111 | 1.95 ± 0.29 |
	| `sha512` | 0.079 ± 0.004 | 0.075 | 0.095 | 1.93 ± 0.26 |
	| `siphash128` | 0.041 ± 0.004 | 0.035 | 0.050 | 1.00 ± 0.17 |
	| `siphash64` | 0.041 ± 0.005 | 0.035 | 0.057 | 1.00 |
	| `skein256` | 0.089 ± 0.016 | 0.068 | 0.120 | 2.17 ± 0.48 |
	| `skein512` | 0.088 ± 0.016 | 0.069 | 0.116 | 2.14 ± 0.49 |
	| `sm3` | 0.048 ± 0.004 | 0.044 | 0.060 | 1.17 ± 0.18 |
	| `streebog256` | 0.585 ± 0.007 | 0.579 | 0.603 | 14.26 ± 1.84 |
	| `streebog512` | 0.584 ± 0.005 | 0.577 | 0.594 | 14.25 ± 1.83 |
	| `tiger2` | 0.055 ± 0.003 | 0.052 | 0.070 | 1.34 ± 0.19 |
	| `tiger` | 0.055 ± 0.004 | 0.051 | 0.077 | 1.34 ± 0.20 |
	| `whirlpool` | 0.303 ± 0.003 | 0.301 | 0.309 | 7.40 ± 0.95 |
	| `xoodyak` | 0.081 ± 0.004 | 0.078 | 0.094 | 1.98 ± 0.27 |
